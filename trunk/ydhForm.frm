...
Begin {C62A69F0-16DC-11CE-9E98-00AA00574A4F} ydhForm 
   Caption         =   "Yahoo Download History - Single Ticker"
   ClientHeight    =   4695
   ClientLeft      =   45
   ClientTop       =   435
   ClientWidth     =   4620
...
Private Sub UserForm_Initialize()
    Const tickers As String = "^DJI   Dow Jones Industrial Average|^FTSE    FTSE 100|^HSI   HANG SENG INDEX|^IXIC   NASDAQ Composite|^N225  NIKKEI 225|^OMX  OMXS30|^GSPC   S&P 500 INDEX|^RUA    RUSSELL 3000|^FVX     Treasury Yield 5 Years|^TNX     Treasury Yield 10-Years|^TYX    Treasury Yield 30 Years|" & _
